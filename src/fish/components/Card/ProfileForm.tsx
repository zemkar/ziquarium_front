...
import { getFishProfile, modFishProfile } from '../../actions/fishes';
...
const ProfileForm = () => {
    ...
    const onSubmit = (data: any) => {
        ...
        const toSend = { ...data, fish: fishData.fish }

        dispatch(modFishProfile(toSend))
            .then(
                (res: any) => {
                    dispatch(getFishProfile(fishData.fish));
                },
